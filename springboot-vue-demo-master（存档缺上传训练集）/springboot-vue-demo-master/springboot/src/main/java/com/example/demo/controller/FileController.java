...
public class FileController extends BaseController {
    ...
    public Result<?> upload_KNN(MultipartFile file) throws IOException {
        ...
        try {
            train_set = readTrainSet(System.getProperty("user.dir") + "/files/" + flag + "_" + originalFilename);
        } catch (IOException e) {
        ...
        try {
            test_set = readTrainSet(System.getProperty("user.dir") + "/files/Lucene.csv");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public Result<?> upload_LR(MultipartFile file) throws IOException {
        ...
        try {
            lr_train_set = readTrainSetLr(System.getProperty("user.dir") + "/files/" + flag + "_" + originalFilename);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        ...
        try {
            lr_test_set = readTrainSetLr(System.getProperty("user.dir") + "/files/Lucene.csv");
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
