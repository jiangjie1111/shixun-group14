...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (9, '1497', '206', '997', '791', '0.8084252758274825', NULL, NULL, NULL, NULL);
INSERT INTO `book` VALUES (10, '691', '208', '1497', '1289', '0.8550434201736807', NULL, NULL, NULL, NULL);
INSERT INTO `book` VALUES (11, '997', '208', '1497', '1289', '0.8483633934535738', NULL, NULL, NULL, NULL);
INSERT INTO `book` VALUES (12, '1497', '206', '997', '791', '0.8084252758274825', NULL, NULL, NULL, NULL);
INSERT INTO `book` VALUES (13, '1497', '206', '997', '791', '0.8084252758274825', NULL, NULL, NULL, NULL);
...
CREATE TABLE `message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '留言表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `message` VALUES (30, '13123', '12', '2022-10-19 18:04:50', NULL, 0);
INSERT INTO `message` VALUES (31, '123', 'admin', '2022-10-19 18:05:37', 30, 0);
INSERT INTO `message` VALUES (32, '123', 'admin', '2022-12-14 15:47:20', NULL, 0);
INSERT INTO `message` VALUES (33, '23123', 'admin', '2022-12-14 15:47:24', 32, 0);
INSERT INTO `message` VALUES (34, '1234523', 'hr', '2022-12-14 15:53:37', NULL, 0);
INSERT INTO `message` VALUES (35, '123443', 'admin', '2022-12-14 15:54:37', 34, 0);
...
-- ----------------------------
INSERT INTO `permission` VALUES (1, 'Home', '/home', '仓库管理', 'el-icon-house');
INSERT INTO `permission` VALUES (2, 'Category', '/category', '货品资料', 'el-icon-menu');
INSERT INTO `permission` VALUES (3, 'Book', '/book', '客户管理', 'el-icon-files');
INSERT INTO `permission` VALUES (4, 'News', '/news', '供应商', 'el-icon-news');
...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES (34, '1497', '997', '740', '257', '0.7422266800401204', 718, 130, 127, 22, NULL, 0);
INSERT INTO `t_order` VALUES (35, '997', '691', '435', '256', '0.6295224312590448', 403, 144, 112, 32, NULL, 0);
INSERT INTO `t_order` VALUES (36, '1497', '997', '740', '257', '0.7422266800401204', 718, 130, 127, 22, NULL, 0);
INSERT INTO `t_order` VALUES (37, '1497', '997', '740', '257', '0.7422266800401204', 718, 130, 127, 22, NULL, 0);
...
INSERT INTO `user` VALUES (19, '12', '$2a$10$TdPmjuCJFvAllHvJlf5gluOb7nVB2jRDdQiWxhQIRaj0c/YMefVkC', '用户158267', 12, 'nan', NULL, NULL, 0.00);
INSERT INTO `user` VALUES (20, 'czy', '$2a$10$.GlDxYlB3XV5kTqISbOAE.M2XdfYb7TgL3UJfqoobaOmqeZ9.3jzi', '用户1596755705433772033', NULL, NULL, NULL, NULL, 0.00);
INSERT INTO `user` VALUES (21, 'cat', '$2a$10$zGhHLVGGYGTMCorQ2YYWXeNBSw0aleEtFxj8zRpwm4R7A4q/3T3Em', '用户1596766507389747201', NULL, NULL, NULL, NULL, 0.00);
INSERT INTO `user` VALUES (22, 'hscccc', '$2a$10$N.fNMCMMXai7v2IkGM3vYeWUE61t038JIZrPtLp3KBoz9uax.NcfS', '用户1601811582029930497', NULL, NULL, NULL, NULL, 0.00);
INSERT INTO `user` VALUES (23, 'hr', '$2a$10$QsS4wsYx95Fui78GnwA.Le9pcz14pSr3EwqI0VOU5nh.Ba4U9SpWG', '用户1602928484800589825', NULL, NULL, NULL, NULL, 0.00);
